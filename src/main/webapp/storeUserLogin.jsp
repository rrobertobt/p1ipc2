...
<body>
<jsp:include page="/WEB-INF/login-nav/StoreUserLoginNav.jsp"/>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="text-center">Usuario de tienda</h6>
                    <form id="form-login" action="${pageContext.request.contextPath}/StoreUserLoginServlet" method="POST">
                        <div class="mb-3">
            ...
            <div class="card mt-4">
                <div class="card-body">
                    <h5 class="card-title">No eres usuario de tienda?</h5>
